...
## Make a Plot of Satisfaction by Length of Presentation in Minutes

```{r Satisfaction-Plot}
Excitement %>% 
  ggplot(mapping = aes(x=Length_of_Presentation, y=Satisfaction_From_Presentation2)) + #our aes statement will tell R which variables we would like on each axis
  geom_point() + #geom_point is used to make the scatterplot
  xlab("Length of Presentation in Minutes") +
  ylab("Satisfaction Level of the Audience") + #xlab and ylab are used to make our axis more readable
